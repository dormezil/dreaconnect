...
The goal of dreaconnect is to make connecting to database through R easier. Some basic utility functions such as listing tables in a database are also included.
